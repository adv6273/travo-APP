...
//             try {
//                 const response = await axios.get('http://localhost:4000/BookingRequests', {
...
//         try {
//             await axios.delete(`http://localhost:4000/BookingRequests/${bookingId}`, {
//                 withCredentials: true,
//             });
...
//                 <div 
//                     key={booking._id} className='flex gap-4 pr-13 mr-4 grow mt-5 text-xl bg-blue-100'>
//                     <div className='w-1/4 h-auto'> 
//                         <img src={`http://localhost:4000/uploads/${booking.place.photos?.[0]}`} alt="no_image_provided" className='w-full h-auto object-cover aspect-square rounded' />
//                     </div>
//                     <div className='w-2/3'>
...
function BookingRequests() {
    ...
    const handleDelete = async (bookingId) => {
        ...
        try {
            const response = await axios.delete(`http://localhost:4000/BookingRequests/${bookingId}`, {
                withCredentials: true,
            });
